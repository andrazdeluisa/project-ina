...
References should be cited in numerical order as they appear in text; this will be done automatically via bibtex, e.g.  and... All references should be included in the main manuscript file.  
